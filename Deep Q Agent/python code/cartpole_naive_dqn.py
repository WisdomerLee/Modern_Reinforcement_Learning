...
#하나의 네트워크로 두 가지 작업을 실행함...

#화면의 그림을 Convolutional Neural network로 처리하기
#3개의 채널을 가진 것을 하나의 채널로(흑백 그림으로 변경)
#그림의 크기를 줄일 것 > pixel단위를 줄이는데 convolution기법이 쓰임
#이전 2 프레임의 정보를 가지고 있을 것
#행동을 4번 반복
#채널을 처음 위치로 바꾸기
#4개의 프레임을 추적
#입력의 크기를 조절할 것